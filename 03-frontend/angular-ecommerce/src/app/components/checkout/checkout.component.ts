...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // read te user's email addresss from browser storage
  ...
  reviewCartDetails() {
    ...
    // subscribe to cartService.totalQuantity, price
  ...
  onSubmit() {
    ...
    // populate purchsae -shipping address
